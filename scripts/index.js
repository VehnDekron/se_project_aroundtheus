...
const imageModalCloseBtn = previewImageModal.querySelector(
  "#modal-close-button"
);
const modalPreviewImage = previewImageModal.querySelector(
  ".modal__preview-image"
);
const modalImageCaption = previewImageModal.querySelector(
